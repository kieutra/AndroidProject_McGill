    ...
    public void clickClear(){
        clear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPreferences sf_nempork = getSharedPreferences("storednemPork", MODE_PRIVATE);
                sf_nempork.edit().clear().apply();

                SharedPreferences sf_nemChicken = getSharedPreferences("storednemChicken", MODE_PRIVATE);
                sf_nemChicken.edit().clear().apply();

                SharedPreferences sf_nemVege = getSharedPreferences("storednemVege", MODE_PRIVATE);
                sf_nemVege.edit().clear().apply();

                SharedPreferences sf_bmpork = getSharedPreferences("storedbmPork", MODE_PRIVATE);
                sf_bmpork.edit().clear().apply();

                SharedPreferences sf_bmChicken = getSharedPreferences("storedbmChicken", MODE_PRIVATE);
                sf_bmChicken.edit().clear().apply();

                SharedPreferences sf_bmVege = getSharedPreferences("storedbmVege", MODE_PRIVATE);
                sf_bmVege.edit().clear().apply();

                SharedPreferences sf_bbtTaro = getSharedPreferences("storedbbtTaro", MODE_PRIVATE);
                sf_bbtTaro.edit().clear().apply();

                SharedPreferences sf_bbtChoco = getSharedPreferences("storedbbtChoco", MODE_PRIVATE);
                sf_bbtChoco.edit().clear().apply();

                SharedPreferences sf_bbtMatcha = getSharedPreferences("storedbbtMatcha", MODE_PRIVATE);
                sf_bbtMatcha.edit().clear().apply();

                SharedPreferences sf_mochiTaro = getSharedPreferences("storedmochiTaro", MODE_PRIVATE);
                sf_mochiTaro.edit().clear().apply();

                SharedPreferences sf_mochiMatcha = getSharedPreferences("storedmochiMatcha", MODE_PRIVATE);
                sf_mochiMatcha.edit().clear().apply();

                SharedPreferences sf_mochiSakura = getSharedPreferences("storedmochiSakura", MODE_PRIVATE);
